...
export const metadata = {
  ...
  description:
    'Dogtor 逗課是國高中生最喜歡的 AI 複習 App：海量題庫刷題、隨時問 AI 解題、跟朋友互動一起讀、即時對戰 PK、AI 分析弱點、個人化推薦下一題，一站搞定國中會考、高中學測、分科測驗複習。可愛的介面、輕鬆快樂刷題，還能揪同學一起對戰，把枯燥複習變成每天想打開的小確幸。由台大學生與補習班老師聯手開發，並由多位台大教授顧問在 AI、軟體、HCI、學習互動等方面提供專業指導。',
  keywords: [
    // 品牌
    'Dogtor',
    '逗課',
  ...
  openGraph: {
    ...
    description:
      '國高中生最喜歡的 AI 複習 App：題庫刷題、問 AI 解題、好友互動對戰、AI 分析弱點、個人化推薦，一站搞定會考學測複習。可愛介面、快樂刷題，由台大學生與補習班老師聯手開發、台大教授顧問指導。',
  ...
  twitter: {
    ...
    title: 'Dogtor 逗課 | 國高中生最愛的 AI 複習 App',
    description:
      '題庫刷題、問 AI 解題、好友對戰、AI 分析弱點、個人化推薦，一站搞定會考學測複習。可愛介面、快樂刷題，由台大學生與補習班老師聯手開發、台大教授顧問指導。',
    images: ['/dogtor_cover.png'],
  },
  icons: {
    icon: '/app_icon.png',
