const messages = {
  'zh-TW': {
    ...
    faq: {
      ...
      parentSectionTitle: '家長訂閱 Dogtor Pro',
      parentSectionSubtitle: '關於 Dogtor Pro 家長訂閱方案的常見問題。',
      items: [
        {
      ...
      parentSections: [
        {
          ...
          items: [
            {
              question: 'Dogtor Pro 有哪些方案？',
              answer: 'Dogtor Pro 提供月訂閱和年訂閱兩種方案。年訂閱享有更優惠的價格。訂閱期間，綁定的孩子可使用所有 Pro 功能。',
            },
            {
              question: '如何訂閱 Dogtor Pro？',
              answer: '1. 透過 LINE 官方帳號輸入「訂閱」，點選連結前往訂閱頁面。\n\n2. 選擇方案並完成付款。\n\n3. 付款成功後，系統會自動產生一組授權碼。\n\n4. 將授權碼提供給孩子，在 App 中輸入即可啟用 Pro。',
            },
            {
              question: '付款方式有哪些？',
            ...
            {
              question: '訂閱會自動續訂嗎？',
              answer: '會。訂閱到期前系統會自動續訂，孩子的 Pro 功能不會中斷。如果需要取消，請在到期前透過 LINE 官方帳號輸入「取消訂閱」進行管理。',
            },
            {
              question: '如何取消訂閱？',
              answer: '透過 LINE 官方帳號輸入「取消訂閱」，系統會提供訂閱管理頁面的連結。您可以在該頁面取消訂閱、更換付款方式或查看帳單紀錄。取消後，孩子可繼續使用 Pro 功能直到當期結束。',
            },
            {
              question: '付款失敗怎麼辦？',
            ...
            {
              question: '有免費試用嗎？',
              answer: 'Dogtor 的核心功能（題庫練習、好友對戰、基礎 AI 解題）本身就是免費的，您的孩子可以先體驗看看。Pro 方案提供的是進階功能（無限愛心、完整錯題本、進階 AI 助手、學習報告等），目前沒有免費試用期，但您可以隨時取消訂閱。',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: '不會。每份訂閱獨立運作，取消其中一份不會影響其他孩子的 Pro 功能。',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              question: '孩子的 Pro 什麼時候生效？',
              answer: '孩子完成授權碼綁定後，Pro 功能立即生效。',
            },
            {
              question: '訂閱取消後，孩子的學習紀錄會消失嗎？',
              answer: '不會。取消訂閱後，孩子的學習紀錄、錯題本、成就等資料都會保留。只是 Pro 專屬功能會在當期結束後停用。',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            {
              question: '有退款政策嗎？',
              answer: '訂閱後如需退款，請於 14 天內聯絡客服處理。超過 14 天的訂閱依照付款平台的退款規定辦理。退款完成後，對應孩子的 Pro 功能將立即停用。',
            },
          ],
        },
      ],
  ...
  en: {
    ...
    faq: {
      ...
      parentSectionTitle: 'Parent Subscription — Dogtor Pro',
      parentSectionSubtitle: 'Frequently asked questions about the Dogtor Pro parent subscription.',
      items: [
        {
      ...
      parentSections: [
        {
          ...
          items: [
            {
              question: 'What plans does Dogtor Pro offer?',
              answer: 'Dogtor Pro offers monthly and yearly subscription plans. The yearly plan comes at a discounted rate. During the subscription period, your linked child can access all Pro features.',
            },
            {
              question: 'How do I subscribe to Dogtor Pro?',
              answer: '1. Enter "subscribe" in the LINE official account to get the subscription page link.\n\n2. Choose a plan and complete payment.\n\n3. After successful payment, the system will generate an authorization code.\n\n4. Give the code to your child to enter in the App to activate Pro.',
            },
            {
            ...
            },
            {
              ...
              answer: 'Yes. The subscription automatically renews before expiration so your child\'s Pro features are uninterrupted. To cancel, enter "cancel subscription" in the LINE official account before the renewal date.',
            },
            {
              question: 'How do I cancel my subscription?',
              answer: 'Enter "cancel subscription" in the LINE official account. The system will provide a link to the subscription management page where you can cancel, change payment methods, or view billing history. After cancellation, your child can continue using Pro features until the current period ends.',
            },
            {
            ...
            },
            {
              ...
              answer: 'Dogtor\'s core features (question bank, friend battles, basic AI explanations) are already free — your child can try them out first. Pro provides advanced features (unlimited hearts, full mistake book, advanced AI assistant, learning reports, etc.). There is no free trial period, but you can cancel anytime.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: 'No. Each subscription operates independently. Canceling one will not affect the other child\'s Pro features.',
            },
          ],
        },
        {
          ...
          items: [
            {
              question: 'What features does Pro include?',
            ...
            {
              question: 'When does Pro take effect for my child?',
              answer: 'Pro features are activated immediately after your child completes the authorization code binding.',
            },
            {
              question: 'Will my child\'s learning data be lost after canceling?',
              answer: 'No. After cancellation, your child\'s learning records, mistake book, achievements, and other data are all preserved. Only Pro-exclusive features will be deactivated after the current period ends.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              answer: 'If you need a refund, please contact support within 14 days of subscribing. Refunds after 14 days follow the payment platform\'s refund policy. Once refunded, the corresponding child\'s Pro features will be deactivated immediately.',
            },
          ],
        },
      ],
