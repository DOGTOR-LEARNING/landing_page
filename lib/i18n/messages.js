const messages = {
  'zh-TW': {
    ...
    home: {
      ...
      heroTitle1: '精通知識，',
      heroTitle2: '征服島嶼！',
      heroTagline: '遊戲化答題 · 線上競技場對戰 · AI 數位錯題本',
      heroSubtitle: '擺脫枯燥的傳統 PDF 題本與考古題！和 Dogtor 逗課 一起冒險，遊戲化刷題、與好友即時對戰，AI 自動整理錯題，邊玩邊備戰會考學測。',
      floatTitle: '每日挑戰',
      floatDesc: '完成15天連勝！',
      ...
      feature1Title: '線上競技場對戰',
      feature1Desc: '和朋友即時 PvP 對戰、蒐集星星、解鎖成就，告別獨自啃 PDF 考古題，讓刷題像玩遊戲一樣輕鬆，邊玩邊把弱點變強項。',
      feature3ImgAlt: 'Dogtor 逗課 AI 數位錯題本 — 自動記錄錯題、依 108 課綱進度推薦複習',
      feature3Title: 'AI 數位錯題本',
      feature3Desc: '答錯自動收進 AI 數位錯題本，依 108 課綱進度拆解弱點，配合遺忘曲線每天推薦你「今天最該複習的內容」，複習精準不瞎忙。',
  ...
  en: {
    ...
    home: {
      ...
      heroTagline: 'Gamified Quizzes · Live Battle Arena · AI Mistake Notebook',
      heroSubtitle:
        'Ditch the dull PDF question books and past papers! Adventure with Dogtor — gamified practice, real-time battles with friends, and an AI mistake notebook that organizes your weak spots automatically.',
      ...
      feature1Title: 'Live Battle Arena',
      feature1Desc:
        'Challenge friends in real-time PvP battles, collect stars, and unlock achievements — no more grinding through PDF past papers alone, just practice as addictive as a game.',
      feature3ImgAlt: 'Dogtor AI mistake notebook — auto-logs wrong answers and recommends review by curriculum progress',
      feature3Title: 'AI Mistake Notebook',
      feature3Desc:
        'Wrong answers are auto-filed into your AI mistake notebook, which breaks down weak spots by curriculum and uses the forgetting curve to recommend exactly what to review each day.',
