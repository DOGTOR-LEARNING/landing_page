const messages = {
  'zh-TW': {
    ...
    parentPro: {
      ...
      featureBankTitle: '多元專屬題庫',
      featureBankDesc: '解鎖更多進階、跨章節的多元題庫，滿足不同程度的練習需求，面對大小考試都游刃有餘。',
      
      featureCustomTitle: '客製化考試範圍',
      featureCustomDesc: '可依據學校進度或個人弱點，自由勾選單元範圍，AI 將為孩子生成專屬的客製化試卷。',
      
      featureNotebookTitle: '無限錯題本與 AI 解惑',
      featureNotebookDesc: '錯題收錄無上限，並大幅提升 AI 詢問次數。不懂的地方隨時問，將弱點徹底轉化為強項。',
      
      featureAdFreeTitle: '純淨無廣告環境',
      featureAdFreeDesc: '移除軟體內所有廣告干擾，提供最專注、沉浸的學習體驗，讓每一分鐘都發揮最大價值。',

      lineTitle: '加入 Dogtor 家長 LINE，即時掌握學習動態',
      ...
      planFeatures: ['LINE 即時報表通知', '無限學習體力', '解鎖多元題庫', '客製化專屬考卷', '錯題本與 AI 解惑額度提升', '全站無廣告'],
  ...
  en: {
    ...
    parentPro: {
      ...
      featureBankTitle: 'Diverse Question Banks',
      featureBankDesc: 'Unlock advanced and cross-chapter question banks to meet different practice needs. Be ready for any exam.',
      
      featureCustomTitle: 'Customizable Exams',
      featureCustomDesc: 'Select specific chapters based on school progress or personal weaknesses, and let AI generate a fully customized test paper.',
      ...
      featureAdFreeTitle: 'Ad-Free Environment',
      featureAdFreeDesc: 'Remove all ads across the app for a purely focused, immersive learning experience. Make every minute count.',

      lineTitle: 'Add Dogtor on LINE — Stay in the Loop',
      ...
      planFeatures: ['Instant LINE reports', 'More learning energy', 'Diverse question banks', 'Customizable exams', 'Higher AI & mistake limits', 'Ad-free experience'],
