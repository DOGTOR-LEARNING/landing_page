  ...
  'zh-TW': {
    ...
    parentPro: {
      ...
      heroQuestions: [
        '「今天學了什麼？」—「還好啊。」',
        '想關心孩子的學習，卻不知道該從哪裡問起？',
        '學校和補習班學生太多，回饋永遠只有一句「他還可以」？',
        '最後只能用分數衡量學習，卻不知道分數背後是哪個觀念沒學會？',
      ],
      heroDesc: '跟許多家教、補習班的家長與孩子互動後，我們發現：家長其實非常關心孩子的學習，只是一直缺少一個看得見的窗口。DOGTOR PARENT PRO 用 LINE 日報與週報，把孩子第一手的學習狀況與錯題分析直接送到您手上——讓關心從追問分數，變成「這個觀念，我陪你補起來」。',
      ...
      promoNotice: '🎉 暑期新上線優惠價 · 即日起至 9/30，現在訂閱即可鎖定優惠價',
      promoBadge: '暑期優惠',
      monthlyPlan: '月繳方案',
  ...
  en: {
    ...
    parentPro: {
      ...
      heroQuestions: [
        ...
        'You want to help with their studies, but have no idea where to start.',
      ...
      promoNotice: '🎉 Summer launch price · Subscribe before Sep 30 to lock in this deal',
      promoBadge: 'Summer Deal',
