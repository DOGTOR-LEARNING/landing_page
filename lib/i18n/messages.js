const messages = {
  'zh-TW': {
    ...
    home: {
      ...
      featuresSectionTitle: '為什麼學生愛上 Dogtor 逗課？',
      featuresSectionSubtitle: '可愛、快樂、還能揪朋友一起——把「該讀書」變成「想打開」。',
      featureTeamImgAlt: 'Dogtor 逗課學習島嶼 — 輕鬆快樂的遊戲化闖關刷題',
      featureTeamTitle: '輕鬆快樂刷題',
      featureTeamDesc: '把刷題變成冒險闖關，一座座征服學習島嶼、蒐集星星，輕鬆快樂地把弱點變強項。甚至能拍照或上傳任何檔案，讓 AI 把它變成超好玩的專屬題庫，一點都不像在念書。',
      feature1ImgAlt: 'Dogtor 逗課可愛的學霸小狗博士 — 療癒陪伴國高中生學習',
      feature1Title: '可愛介面',
      feature1Desc: '學霸小狗博士 Dogtor 全程陪你學習，畫面療癒可愛、操作簡單好上手，讓每天打開 App 都是一件開心的事。',
  ...
  en: {
    ...
    home: {
      ...
      featuresSectionTitle: 'Why Students Love Dogtor',
      ...
      feature1ImgAlt: 'Dogtor the cute study-whiz corgi — a healing companion for students',
      feature1Title: 'Adorable Interface',
      feature1Desc:
        'The study-whiz corgi Dogtor is with you every step — a healing, adorable interface that is simple to use, making opening the app a little joy every day.',
